...
<div class="w3-col s12 w3-panel w3-small">
    <div class="w3-col s12 w3-margin-top w3-margin-bottom w3-padding">
        <div class="w3-panel w3-bottombar w3-padding">
            ...
            <button class="w3-button w3-red w3-right w3-round-medium" onclick="close_it()">Close</button>
        </div>
    </div>
    <div class="w3-col s12 m4 w3-panel">
        <div class="w3-col s12 w3-margin-bottom">
            <div class="w3-col s12 w3-container">
                ...
                <input name="pos_name" type="text" id="pos_name" maxlength="100" style="width: 100%" class="w2ui-input w3-round-medium w3-padding-small w3-border" placeholder="Position..">
