                ...
                switch (event.target) {
                    ...
                    case "print":
                        if (w2ui.my_grid.records.length > 0) {
                            ...
                            window.open(src+"?paydate=" + _date + "&pay_group=" + _group + "&cmd=print&option=sss","printarea", "width=900,height=900");
                        } else {
                    ...
                    case "export":
                        if (w2ui.my_grid.records.length > 0) {
                            let _date = $('#paydate').val();
                            let _group = $('#pay_group').w2field().get().id;
                            window.open(src+"?paydate=" + _date + "&pay_group=" + _group + "&cmd=export&option=sss");
                        } else {
                            w2alert("Please generate report!");
                        }
                        break;
